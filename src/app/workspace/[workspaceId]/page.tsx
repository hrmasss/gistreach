          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {usage.socialAccounts.used} / {usage.socialAccounts.limit}
                    </p>
                  </div>
                ...
                <div className="mt-4">
                  <div className="bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{ width: `${Math.min((usage.socialAccounts.used / usage.socialAccounts.limit) * 100, 100)}%` }}
                    ></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Monthly Posts</p>
                    <p className="text-2xl font-bold text-gray-900">
                      {usage.monthlyPosts.used} / {usage.monthlyPosts.limit}
                    </p>
                  </div>
                ...
                <div className="mt-4">
                  <div className="bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{ width: `${Math.min((usage.monthlyPosts.used / usage.monthlyPosts.limit) * 100, 100)}%` }}
                    ></div>
                  </div>
                </div>
              </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button className="p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-left">
              ...
              <p className="text-sm text-gray-600 mt-1">Start creating new social media content</p>
            </button>
            ...
            <button className="p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-left">
              ...
              <h3 className="font-medium text-gray-900">Connect Accounts</h3>
              <p className="text-sm text-gray-600 mt-1">Link your social media accounts</p>
            </button>
            ...
            <button className="p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-left">
              ...
              <p className="text-sm text-gray-600 mt-1">Check your content performance</p>
            </button>
            ...
            <button className="p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-left">
              ...
              <p className="text-sm text-gray-600 mt-1">Plan your content calendar</p>
            </button>
          </div>
        </div>
